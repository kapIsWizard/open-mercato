...
const routeMetadata = {
  ...
  POST: { requireAuth: true, requireFeatures: ['purchasing.items.update'] },
  PUT: { requireAuth: true, requireFeatures: ['purchasing.items.update'] },
  DELETE: { requireAuth: true, requireFeatures: ['purchasing.items.update'] },
}
